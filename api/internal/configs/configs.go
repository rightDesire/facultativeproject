...
import (
	...
	"github.com/rightDesire/facultativeproject/common/redis"
...
func (o *Configs) NewKafkaSyncProducer() sarama.SyncProducer {
	...
	producer, err := sarama.NewSyncProducer(o.KAFKA_BROKERS, config)
	if err != nil {
		panic(err)
	}
